    ...
    <div class="layui-layout layui-layout-admin">
      <div class="layui-header">
        ...
        <ul class="layui-nav layui-layout-right" lay-filter="layadmin-layout-right">
          ...
          <li class="layui-nav-item" lay-unselect>
            <a href="javascript:;">
              <cite>${sessionScope.loginUser.name}</cite>
            </a>
      ...
      <div class="layui-side layui-side-menu">
        <div class="layui-side-scroll">
          <div class="layui-logo" lay-href="home/homepage2.html">
            <span>员工操作平台</span>
          </div>
          
          <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu" lay-filter="layadmin-system-side-menu">
            <li data-name="count" class="layui-nav-item layui-nav-itemed layui-this">
              <a lay-href="home/homepage2.html" lay-tips="店铺经营状况" lay-direction="2">
                <i class="layui-icon layui-icon-chart" style="font-size: 18px;"></i>
                <cite>店铺经营状况</cite>
              </a>
            </li>
            <li data-name="plan" class="layui-nav-item">
              <a href="javascript:;" lay-tips="排课" lay-direction="2">
              ...
              <dl class="layui-nav-child">
                ...
                <!--预约  -->
                  <a lay-href="component/timeline/index.jsp">预约</a>
                </dd>
                <dd data-name="console">
                  <a lay-href="component/calendar/index.jsp">排课</a>
                </dd>
              </dl>
            </li>
            <li data-name="component" class="layui-nav-item">
               <a href="javascript:void(0);" lay-tips="上课签到" lay-direction="2" onclick="isLoad()">
                <i class="layui-icon layui-icon-vercode"style="font-size: 18px;"></i>
                <cite>上课签到</cite>
              </a>
              <!--<dl class="layui-nav-child">-->
                <!--<dd data-name="grid">-->
            ...
            <li data-name="template" class="layui-nav-item">
              <a href="javascript:;" lay-tips="信息录入" lay-direction="2">
                <i class="layui-icon layui-icon-edit"style="font-size: 18px;"></i>
                <cite>信息录入</cite>
              </a>
              <dl class="layui-nav-child">
                <dd><a lay-href="template/personalpage.html">学员信息</a></dd>
                <dd><a lay-href="#">讲师信息</a></dd>
            ...
            <!--</li>-->
            <li data-name="set" class="layui-nav-item">
              <a href="javascript:;" lay-href="" lay-tips="设置" lay-direction="2">
            ...
            <li data-name="about" class="layui-nav-item">
              <a href="javascript:;" lay-href="" lay-tips="关于" lay-direction="2">
                <i class="layui-icon layui-icon-about"style="font-size: 18px;"></i>
                <cite>关于</cite>
              </a>
            </li>
          </ul>
      ...
      <div class="layadmin-pagetabs" id="LAY_app_tabs">
        ...
        <div class="layui-tab" lay-unauto lay-allowClose="true" lay-filter="layadmin-layout-tabs">
          <ul class="layui-tab-title" id="LAY_app_tabsheader">
            <li lay-id="home/homepage2.html" lay-attr="home/homepage2.html" class="layui-this"><i class="layui-icon layui-icon-home"></i></li>
          </ul>
        </div>
      </div>
      ...
      <div class="layui-body" id="LAY_app_body">
        <div class="layadmin-tabsbody-item layui-show">
          <iframe src="home/homepage2.html" frameborder="0" class="layadmin-iframe"></iframe>
        </div>
      </div>
  ...
  layui.config({
    ...
    function isLoad(){
    	layer.open({
                       ...
                       maxmin: false,
                       resize: false,
                       content: 'component/form/element.jsp',
